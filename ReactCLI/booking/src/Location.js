    ...
    <div className="card  h-100">
        <Link to={"/room/" + (props.room.slug ?? props.room.id) }>
            <img src={photoPath + (props.room.photoUrl ?? "no-image.jpg")} 
                className="card-img-top" alt="room" />
    ...
    <div className="row">
        <div className="col">
            <button type="submit" className="btn btn-secondary"
                    name="room-button" value="true">Додати</button>
        </div>
    </div>
...
/*
Д.З. [Додавання кімнати] Реалізувати очищення форми додавання кімнати
у випадку, якщо додавання пройшло успішно. Також у цьому випадку
вивести повідомлення "Додано успішно".
** Додати клієнтську валідацію форми, тобто за відсутності необхідних
   полів не надсилати дані, а виводити повідомлення про брак даних
